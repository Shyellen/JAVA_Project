...
public class newgame extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
    {
        ...
        if (actionCommand.equals("게임시작") || actionCommand.equals("재시작")) { //초기값으로 변경.
        	...
        	Sound("341695__projectsu012__coins-1.wav", false);
        	Sound("FiluAndDina_-_8-bit_Funny_Theme_-_Long_Edit.wav", true);
	...
	public void paint(Graphics g)
    {
        ...
        if(start == true) {
        	...
        	super.paint(g);
        	Stop_sound();
        	Sound("333785__projectsu012__8-bit-failure-sound.wav", false);
